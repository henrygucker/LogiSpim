...
*Expected Release during the Fall Semester of 2026.*
___
...
### Short Demo
This video demonstrates how LogiSpim can be used to see the execution flow of instructions throughout pipeline stages.
